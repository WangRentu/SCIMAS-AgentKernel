...
from examples.scimas_mve.components.state_component import ScimasStateComponent
...
from examples.scimas_mve.plugins.agent.invoke.EasyInvokePlugin import EasyInvokePlugin
from examples.scimas_mve.plugins.agent.perceive.EasyPerceivePlugin import EasyPerceivePlugin
from examples.scimas_mve.plugins.agent.profile.EasyProfilePlugin import EasyProfilePlugin
from examples.scimas_mve.plugins.agent.state.EasyStatePlugin import EasyStatePlugin
from examples.scimas_mve.plugins.agent.plan.EasyPlanPlugin import EasyPlanPlugin
from examples.scimas_mve.plugins.agent.reflect.EasyReflectPlugin import EasyReflectPlugin

from examples.scimas_mve.plugins.action.communication.EasyCommunicationPlugin import EasyCommunicationPlugin
from examples.scimas_mve.plugins.action.research.ResearchActionsPlugin import ResearchActionsPlugin
from examples.scimas_mve.plugins.environment.relation.EasyRelationPlugin import EasyRelationPlugin
from examples.scimas_mve.plugins.environment.space.EasySpacePlugin import EasySpacePlugin
from examples.scimas_mve.plugins.environment.science.AIRSWorldPlugin import AIRSWorldPlugin
...
environment_plugin_class_map = {
    ...
    "AIRSWorldPlugin": AIRSWorldPlugin,
}
