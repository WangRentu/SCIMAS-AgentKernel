...
def main() -> None:
    parser = argparse.ArgumentParser(description="Aggregate archived scimas_mve experiment runs.")
    parser.add_argument("--experiment-name", required=True, help="Folder name under examples/scimas_mve/logs/experiments/")
