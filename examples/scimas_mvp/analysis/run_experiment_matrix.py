...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run comparable multi-seed scimas_mvp experiments and archive results.")
    ...
    for variant in chosen_variants:
        for seed in seeds:
            ...
            cmd = [args.python, "-m", "examples.scimas_mvp.run_simulation"]
    ...
    print("Next: python -m examples.scimas_mvp.analysis.aggregate_experiment_runs --experiment-name", args.experiment_name)
